...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, Comparator.comparing(stock -> stock.get("name").toString()));

        Collections.sort(list, (stock1, stock2) ->
        stock2.get("date").toString().compareTo(stock1.get("date").toString()));

        Collections.sort(list, (stock1, stock2) -> {
            if (stock1.containsKey("change") && stock2.containsKey("change")) {
                return Double.compare((double) stock2.get("change"), (double) stock1.get("change"));

            } else if (!stock2.containsKey("change") && stock1.containsKey("change")) {
                return Double.compare(((double) stock2.get("last") - (double) stock2.get("open")),
                                                                     (double) stock1.get("change"));

            } else if (stock2.containsKey("change") && !stock1.containsKey("change")) {
                return Double.compare((double) stock2.get("change"),
